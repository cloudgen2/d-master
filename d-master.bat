...
class Signal(object):
    ...
    def __init_signal__(self):
        if not hasattr(self, '__signal_inited__'):
            ...
            Attr(self, 'signal', 0)
            self.errorState = FiniteStateMachine()
...
class MsgBase(AppData, Sh):
    ...
    def __init__(self, this=None):
        ...
        if not hasattr(self, "__msgbase_inited__"):
            ...
            Attr(self,"useColor", not self.isGitBash())
...
class AppBase(AppPara, ShellProfile, Curl, Temp, Ask):
    ...
    def __init__(self, this = None):
        ...
        # self.__init_docker_build__() ## should be called in self.setInstallation()
...
class DockerBuild(DockerConfig):
    ...
    def __init__(self, this=None):
        ...
        self.__init_docker_build__()
        
    def __init_docker_build__(self):
        Attr(self, 'hasEtc', False)
        Attr(self, 'hasLib', False)
        Attr(self, 'hasLib64', False)
        Attr(self, 'hasOpt', False)
        Attr(self, 'hasRoot', False)
        Attr(self, 'hasUsr', False)
        Attr(self, 'hasVar', False)
        ...
        if result:
            ...
            if overwritten :
                ...
                if cmd != '' :
                    ...
                    params = params + ' -i -v "%s:%s" ' % ( dockerPath, self.exposedVolume())
                    if self.is_mac() or self.is_window():
...
if __name__ == "__main__":
    ...
    app.setInstallation(appName='d-master',author='Cloudgen Wong',homepage="https://github.com/cloudgen2/d-master",downloadUrl="https://dl.leolio.page/d-master",lastUpdate='2024-5-27',majorVersion=17,minorVersion=27)
    app.start()